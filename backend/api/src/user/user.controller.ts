...
export class UserController {
	...
	@ApiOperation({
		description:
			'User Sign Up - Password : uppercase, lowercase, number and special character',
	})
	...
	@ApiOperation({
		...
		description:
			"Indique si un user est actuellement connecté en vérifiant l'existance d'un cookie",
	})
